  ...
  return (
    <div className="bg-[#171212] min-h-screen flex flex-col">
        ...
        <section className="flex-1 flex items-center justify-center px-8 py-32">
          ...
          >
            <div className="w-16 h-px bg-[#B8978A] mx-auto mb-8" />
            <p className="text-[#B8978A] text-xs tracking-[0.4em] uppercase mb-4">Coming Soon</p>
            <h2 className="text-3xl font-extralight text-white tracking-tight mb-6">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-3 text-white/50 text-xs tracking-[0.3em] uppercase hover:text-[#B8978A] transition-colors"
            >
              ← Back to Home
            </Link>
          </motion.div>
