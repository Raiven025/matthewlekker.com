    ...
    <div className="bg-[#0a0a0a] min-h-screen flex flex-col">
        ...
        <section className="flex-1 flex items-center justify-center px-8 py-32">
          ...
          >
            ...
            <p className="text-[#c9a96e] text-xs tracking-[0.4em] uppercase mb-4">Coming Soon</p>
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-3 text-white/50 text-xs tracking-[0.3em] uppercase hover:text-[#c9a96e] transition-colors"
            >
              ← Back to Home
            </Link>
          </motion.div>
