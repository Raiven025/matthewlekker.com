    ...
    <div className="bg-[#0D0D0D]">
      <section className="bg-[#0D0D0D] pt-20 pb-6 px-8 md:px-20">
        ...
        <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
          className="text-[#C47B4A] text-xs tracking-[0.4em] uppercase mb-4">Spaces</motion.p>
        <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }}
          className="text-5xl md:text-7xl font-extralight text-[#F0EDE8] tracking-tight">Commercial</motion.h1>
