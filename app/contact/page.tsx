          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="border-l border-[#c9a96e]/30 pl-5">
                  <p className="text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-1">Email</p>
                  <a href="mailto:info@matthewlekker.com" className="text-white/70 hover:text-[#c9a96e] transition-colors text-sm">
                    info@matthewlekker.com
                  </a>
                </div>
                <div className="border-l border-[#c9a96e]/30 pl-5">
                  <p className="text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-1">Instagram</p>
                  <a href="https://www.instagram.com/matthewlekker/" target="_blank" rel="noreferrer" className="text-white/70 hover:text-[#c9a96e] transition-colors text-sm">
                    @matthewlekker
                  </a>
                </div>
                <div className="border-l border-[#c9a96e]/30 pl-5">
                  <p className="text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-1">Service Area</p>
                  <p className="text-white/70 text-sm">New Jersey · New York · Connecticut</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              {submitted ? (
                <div className="border border-[#c9a96e]/30 p-12 text-center">
                  ...
                  <p className="text-[#c9a96e] text-xs tracking-[0.4em] uppercase mb-4">Message Received</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-2">Name *</label>
                      <input
                        type="text" name="name" required value={form.name} onChange={handleChange}
                        className="w-full bg-transparent border border-white/10 focus:border-[#c9a96e] px-4 py-3 text-white text-sm outline-none transition-colors placeholder:text-white/20"
                        placeholder="Your name"
                      />
                    </div>
                    <div>
                      <label className="block text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-2">Email *</label>
                      <input
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-2">Phone</label>
                      <input
                    ...
                    <div>
                      <label className="block text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-2">Project Type</label>
                      <select
                        name="projectType" value={form.projectType} onChange={handleChange}
                        className="w-full bg-[#0a0a0a] border border-white/10 focus:border-[#c9a96e] px-4 py-3 text-white text-sm outline-none transition-colors appearance-none"
                      >
                  ...
                  <div>
                    <label className="block text-[#c9a96e] text-xs tracking-[0.3em] uppercase mb-2">Message *</label>
                    <textarea
                  ...
                  <button
                    ...
                    className="w-full bg-[#c9a96e] text-black text-xs tracking-[0.3em] uppercase py-4 hover:bg-[#e8d5a3] transition-all duration-300 font-medium disabled:opacity-50"
                  >
