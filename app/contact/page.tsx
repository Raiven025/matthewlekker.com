    ...
    <div className="bg-[#0D0D0D] min-h-screen">
        ...
        <section className="relative h-[50vh] flex items-end pb-20 overflow-hidden">
          ...
          <div className="relative z-10 px-8 md:px-20 w-full">
            <motion.p
              ...
              className="text-[#C8825A] text-xs tracking-[0.4em] uppercase mb-3"
        ...
        <section ref={ref} className="px-8 md:px-20 py-28 max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-start">
            ...
            >
              <p className="text-[#C8825A] text-xs tracking-[0.4em] uppercase mb-4">Get in Touch</p>
              ...
              <p className="text-[#888880] text-base leading-relaxed mb-10">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l border-[#C8825A]/30 pl-5">
                  <p className="text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-1">Instagram</p>
                  <a href="https://www.instagram.com/matthewlekker/" target="_blank" rel="noreferrer" className="text-[#F0EDE8]/70 hover:text-[#E8A882] transition-colors text-sm">
                    @matthewlekker
                  </a>
                </div>
                <div className="border-l border-[#C8825A]/30 pl-5">
                  <p className="text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-1">Service Area</p>
                  <p className="text-[#F0EDE8]/70 text-sm">Available Worldwide</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              {submitted ? (
                <div className="border border-[#C8825A]/30 p-12 text-center">
                  <div className="w-12 h-px bg-[#C8825A] mx-auto mb-6" />
                  <p className="text-[#C8825A] text-xs tracking-[0.4em] uppercase mb-4">Message Received</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-2">Name *</label>
                      <input
                        type="text" name="name" required value={form.name} onChange={handleChange}
                        className="w-full bg-transparent border border-white/10 focus:border-[#C8825A] px-4 py-3 text-white text-sm outline-none transition-colors placeholder:text-[#F0EDE8]/20"
                        placeholder="Your name"
                      />
                    </div>
                    <div>
                      <label className="block text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-2">Email *</label>
                      <input
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-2">Phone</label>
                      <input
                    ...
                    <div>
                      <label className="block text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-2">Project Type</label>
                      <select
                        name="projectType" value={form.projectType} onChange={handleChange}
                        className="w-full bg-[#0D0D0D] border border-white/10 focus:border-[#C8825A] px-4 py-3 text-white text-sm outline-none transition-colors appearance-none"
                      >
                  ...
                  <div>
                    <label className="block text-[#C8825A] text-xs tracking-[0.3em] uppercase mb-2">Message *</label>
                    <textarea
                      name="message" required value={form.message} onChange={handleChange} rows={6}
                      className="w-full bg-transparent border border-white/10 focus:border-[#C8825A] px-4 py-3 text-white text-sm outline-none transition-colors resize-none placeholder:text-[#F0EDE8]/20"
                  ...
                  <p className="text-[#F0EDE8]/20 text-xs text-center tracking-wide">
