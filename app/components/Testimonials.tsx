        ...
        <div className="grid md:grid-cols-3 gap-5">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              className={`border border-white/5 hover:border-[#c9a96e]/20 p-8 flex flex-col gap-5 transition-all duration-500${i === 3 ? ' md:col-start-1 md:col-span-1' : ''}${i === 4 ? ' md:col-start-2 md:col-span-1' : ''}`}
            >
              <Stars />
              ...
              <div className="border-t border-white/5 pt-5 flex items-center gap-4">
                {/* Initial avatar */}
                <div className="w-10 h-10 rounded-full flex-shrink-0 border border-[#c9a96e]/30 bg-[#c9a96e]/8 flex items-center justify-center">
                  <span className="text-[#c9a96e] text-xs font-medium tracking-wide">{t.initials}</span>
                </div>
                <div>
