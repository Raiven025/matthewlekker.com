    ...
    >
      <Link href={cat.href} className="block relative h-[440px] md:h-[520px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-10">
          <p className="text-[#c9a96e] text-xs tracking-[0.35em] uppercase mb-3">{cat.subtitle}</p>
        ...
        <div className="absolute inset-0 border border-[#c9a96e]/0 group-hover:border-[#c9a96e]/25 transition-all duration-500" />
      </Link>
    </motion.div>
  );
}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={ref} className="mb-14 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
          ...
          >
            <Link
              href="/portfolio"
              className="text-white/40 text-xs tracking-[0.3em] uppercase hover:text-[#c9a96e] transition-colors duration-300 flex items-center gap-3"
            >
              View All Work
